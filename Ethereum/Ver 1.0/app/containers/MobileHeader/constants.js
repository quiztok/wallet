...
export const CHECK_BALANCES = 'app/Header/CHECK_BALANCES';
...
export const GET_EXCHANGE_RATES = 'app/Header/GET_EXCHANGE_RATES';
...
export const ASK_FAUCET = 'app/Header/ASK_FAUCET';
export const ASK_FAUCET_SUCCESS = 'app/Header/ASK_FAUCETT_SUCCESS';
export const ASK_FAUCET_ERROR = 'app/Header/ASK_FAUCET_ERROR';

export const CLOSE_FAUCET = 'app/Header/ASK_CLOSE';
...
export const CHANGE_TO = 'app/SendToken/CHANGE_TO';
