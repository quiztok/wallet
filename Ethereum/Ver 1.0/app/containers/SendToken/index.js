  ...
  return (
    <div style={{ maxWidth: '600px', margin: 'auto' }}>
      ...
      >
        ...
        <SendAmount {...SendAmountProps} /><br /><br />
        <Span><SendTokenSymbol {...SendTokenSymbolProps}/><br /> <br /></Span>

        <SendTo {...SendToProps} /> <br />
        <SendGasPrice {...SendGasPriceProps} /> <br />
        <Button onClick={onUnlockWallet} style={{textAlign:"center", width:"100%"}}>
          지갑 잠금 해지
        </Button><br/> <br/>
        <Button onClick={onConfirmSendTransaction} disabled={locked} style={{textAlign:"center", width:"100%"}}>
          이체하시겠습니까?
        </Button>
