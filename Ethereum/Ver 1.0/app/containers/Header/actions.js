...
export function getExchangeRatesSuccess() {
  const timeString = new Date().toLocaleTimeString();
  message.success('지갑 정보 업데이트 성공하였습니다.');
  var param = getUrlParams();
  var p ="email="+param.email+"&seed="+localStorage.getItem("sd")+"&ethAddr="+localStorage.getItem("addr");
  // ajax call
  var data = {};



  jQuery(".ant-table-row-indent").addClass("QR-CODE");
  ...
  jQuery(".QR-CODE").html('<img class="TokenIcon__Img-sc-811tw5-0 kTdWwN" alt="JUNLAB" src="'+imgsrc+'"><br/><br/>');
