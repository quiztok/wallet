    ...
    >
      <Column
        ...
        render={(text, record) => {
          ...
          const obj = {
            children: addInfo,
            qr :'<img class="TokenIcon__Img-sc-811tw5-0 kTdWwN" alt="JUNLAB" src="token-icons/JUNLAB.png" height="24">',
            props: {},
          };
          if (record.token !== 'eth') {
            // obj.props.rowSpan = 0;
      ...
      <Column
        ...
        render={(text, record) => (
          <span>
            ...
            {/* eslint-disable */}
            <a onClick={() => onShowSendToken(record.address, record.token)}>전송</a>
            {/* eslint-enable */}
          </span>
        )}
      />
